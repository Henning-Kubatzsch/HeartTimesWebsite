...
export default async function PreviousEventPage() {
  ...
  return (
    <main className="min-h-screen">
      {/* Parallax-Hero mit Tailwind arbitrary value */}
      <section
        className="relative h-[48vh] md:h-[60vh] bg-[url('/Meta/banner.png')] bg-fixed bg-cover bg-center"
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 to-black/80" />
        <div className="relative z-10 max-w-5xl mx-auto h-full flex items-end px-4 pb-10">
      ...
      <section className="max-w-5xl mx-auto px-4 py-12 text-zinc-200">
        ...
        <div className="mt-10">
          <Link href="/" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl border border-pink-600 hover:bg-pink-600/10">
            {t('back')}
          </Link>
        </div>
      </section>
